...
| Metric | Value |
|---|---|
| Malicious blocked | 47/47 (block-rate 1.00) |
...
```bash
# On the published v3.8.55 release artifact (its exact commit is in RELEASE_MANIFEST.json):
./manage.sh setup
