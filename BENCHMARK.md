...
| Metric | Value |
|---|---|
| Malicious blocked | 40/40 (block-rate 1.00) |
...
```bash
# On the published v3.8.52 release artifact (its exact commit is in RELEASE_MANIFEST.json):
./manage.sh setup
