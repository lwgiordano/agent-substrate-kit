...
| Metric | Value |
|---|---|
| Malicious blocked | 52/52 (block-rate 1.00) |
| Malicious skipped (untested) | 1 |
| Benign false-positives | 0/13 (FP-rate 0.00) |
