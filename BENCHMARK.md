...
| Metric | Value |
|---|---|
| Malicious blocked | 43/43 (block-rate 1.00) |
...
```bash
# On the published v3.8.53 release artifact (its exact commit is in RELEASE_MANIFEST.json):
./manage.sh setup
