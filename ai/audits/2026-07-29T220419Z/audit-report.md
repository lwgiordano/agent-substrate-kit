# Audit report — 2026-07-29T220419Z
...
```text
OVERSIZE DOC (advisory — does not fail the gate):
  - docs/knowledge/00_substrate.md -> ~19612 tok -> budget 3000
  Fix: knowledge docs describe ONE subsystem (contract/organization/scope); per-release narrative belongs in docs/HISTORY.md. Split or trim.
